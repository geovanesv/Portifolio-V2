...
export async function generateMetadata({
  ...
  return {
    title: `${params.repo} | Geovane Araujo`,
...
const Page = async ({ params }: { params: { repo: string } }) => {
  ...
  if (projects.includes(params.repo)) {
    ...
    try {
      ...
      const link = `https://raw.githubusercontent.com/geovanesv/${params.repo}/${meta.default_branch}/README.md`;
  ...
  return (
    <main className="w-full">
      ...
      {project ? (
        <div className="py-20 relative z-10 isolate">
          ...
          <div className="md:min-h-[90vh] px-6 md:px-[15%] shadow-inner">
            ...
            <h1 className="text-center my-10 red-text text-xl">
              Mostrando README de {params.repo}
            </h1>
            ...
            <div className="text-center m-9">
              <Link
                href={`https://github.com/geovanesv/${params.repo}`}
                id="btn"
                target="_blank" 
              >
                Ver no Github
        ...
        <Notfound text={"Não tenho o projeto que você procura"} />
      )}
    </main>
  );
}; 
