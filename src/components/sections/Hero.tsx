  ...
  return (
    <section className="bg-transparent w-full" id="hero">
      <div className="-z-5 relative isolate md:px-6 lg:px-8">
        ...
        >
          <div
            className="-z-20 relative left-[calc(50%-11rem)] aspect-[955/978] md:aspect-[955/508] w-[36.125rem] -translate-x-1/2 xl:-translate-x-1/3 bg-gradient-to-tr from-blue-600 to-[#1fbeda] opacity-30 sm:left-[calc(50%-30rem)] xl:left-[calc(50%-40rem)] sm:-top-[5rem] 2xl:top-[5rem] sm:w-[72.1875rem]"
            style={{
              clipPath:
      ...
      <div className="z-10 text-left px-10 sm:px-16 md:px-[15%] pt-[65%] sm:pt-[40%] md:pt-[22%] lg:pt-[15%] 2xl:pt-[17%] min-h-screen relative">
        <div className="my-2 mb-8 lg:mb-5 z-20">
          <h4 className="md:text-lg 2xl:text-xl z-20">Olá, meu nome é </h4>
          <motion.h1
          ...
          >
            <span className="text-white xron-shade hover:text-gray-400">
              Geovane{" "}
            </span>
            <span className="red-text trix-shade">Araujo</span>
          </motion.h1>
        </div>
